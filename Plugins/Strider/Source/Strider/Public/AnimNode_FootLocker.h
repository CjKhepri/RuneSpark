...
#include "AnimNode_FootLocker.generated.h"
...
struct STRIDER_API FAnimNode_FootLocker : public FAnimNode_SkeletalControlBase
{
	GENERATED_BODY()
...
public:
	...
	EHyperExtensionFixMethod LegHyperExtensionFixMethod;
	...
	FFootLockLimbDefinition LeftFootDefinition;

	/** A data structure defining the right foot and leg for the purposes of foot locking */
	UPROPERTY(EditAnywhere, Category = BodyDefinition)
	FFootLockLimbDefinition RightFootDefinition;
...
private:
	...
	void EvaluateLimb(TArray<FBoneTransform>& OutBoneTransforms, FComponentSpacePoseContext& Output,
	                  const FTransform& ComponentTransform_WS, FFootLockLimbDefinition& LimbDefinition,
