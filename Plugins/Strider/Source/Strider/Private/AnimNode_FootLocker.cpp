...
FAnimNode_FootLocker::FAnimNode_FootLocker()
	: bLeftFootLock(false),
	bRightFootLock(false),
	LegHyperExtensionFixMethod(EHyperExtensionFixMethod::MoveFootTowardsThigh),
...
void FAnimNode_FootLocker::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output,
...
void FAnimNode_FootLocker::EvaluateFootLocking(FComponentSpacePoseContext& Output, 
	TArray<FBoneTransform>& OutBoneTransforms)
{
	const FTransform& ComponentTransform_WS = AnimInstanceProxy->GetSkelMeshComponent()->GetComponentTransform();
...
void FAnimNode_FootLocker::EvaluateLimb(TArray<FBoneTransform>& OutBoneTransforms, FComponentSpacePoseContext& Output,
                                        const FTransform& ComponentTransform_WS, FFootLockLimbDefinition& LimbDefinition, FVector& LockLocation_WS,
...
bool FAnimNode_FootLocker::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
{
...
void FAnimNode_FootLocker::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
...
void FAnimNode_FootLocker::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
	FAnimNode_SkeletalControlBase::CacheBones_AnyThread(Context);
}

void FAnimNode_FootLocker::UpdateInternal(const FAnimationUpdateContext& Context)
{
	FAnimNode_SkeletalControlBase::UpdateInternal(Context);
	DeltaTime = Context.GetDeltaTime();
}

void FAnimNode_FootLocker::GatherDebugData(FNodeDebugData& DebugData)
{
	ComponentPose.GatherDebugData(DebugData);
}

bool FAnimNode_FootLocker::HasPreUpdate() const
{
	return false;
}

void FAnimNode_FootLocker::InitializeBoneReferences(const FBoneContainer& RequiredBones)
{
...
bool FAnimNode_FootLocker::CheckValidBones(const FBoneContainer& RequiredBones)
{
